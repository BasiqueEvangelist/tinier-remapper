...
import me.basiqueevangelist.tinierremapper.api.TrRemapper;
...
class AsmRemapper extends TrRemapper {
	...
	void finish(String className, ClassVisitor cv) {
		...
		if (tr.propagateBridges == TinyRemapper.LinkedMethodPropagation.COMPATIBLE
				|| tr.propagateRecordComponents == TinyRemapper.LinkedMethodPropagation.COMPATIBLE) {
