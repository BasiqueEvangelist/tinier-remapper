...
package me.basiqueevangelist.tinierremapper.extension.mixin.soft.data;

import java.util.Objects;

import me.basiqueevangelist.tinierremapper.api.TrMember;
import me.basiqueevangelist.tinierremapper.extension.mixin.common.StringUtility;
...
public final class MemberInfo {
	...
	public TrMember.MemberType getType() {
		...
		return StringUtility.isMethodDesc(desc) ? TrMember.MemberType.METHOD : TrMember.MemberType.FIELD;
	}
	...
	public String toString() {
		...
		String desc = getDesc().isEmpty() ? "" : (Objects.equals(getType(), TrMember.MemberType.FIELD) ? ":" : "") + getDesc();
